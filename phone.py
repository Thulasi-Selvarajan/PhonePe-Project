...
def ques1():
    ...
    fig_brands= px.bar(brand2, y= "Transaction_count", x= "Brands", color_discrete_sequence=px.colors.sequential.dense_r,
...
def ques5():
    ...
    fig_sa= px.scatter(sa2, x= "States", y= "AppOpens", title="Top 10 States With AppOpens",
